...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // 抓取极速本地系统级缩略图
  getThumbnail: (path, size, options) => ipcRenderer.invoke('get-thumbnail', path, size, options),
  getThumbnailLoadStats: () => ipcRenderer.invoke('thumbnail-load-stats'),
  ...
  installSkillFromGithub: (sourceUrl) => ipcRenderer.invoke('install-skill-from-github', sourceUrl),
  uninstallSkill: (relativePath) => ipcRenderer.invoke('uninstall-skill', relativePath),
